...
- CI/workflow files
- existing hook files
- existing PI extensions and AI tool guards
...
- AI hooks: whether PI has a post-change lint/check hook and a `.env` access guard.
...
- that existing `.env` files are off-limits to AI read and mutation tools
