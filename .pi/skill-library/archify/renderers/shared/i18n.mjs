...
const MESSAGE_PAIRS = {
  ...
  "viewer.preset.choose.title": [
    "Choose visual style (S cycles)",
    "选择视觉风格（S 循环切换）",
  ],
  ...
  "viewer.preset.classic.hint": [
    "Stable technical default",
    "稳定的技术默认风格",
  ],
  ...
  "viewer.preset.editorial.hint": [
    "Publication and launch notes",
    "适合发布与上线说明",
  ],
  "viewer.preset.badge.signalFlow": ["SIGNAL FLOW", "信号流"],
  "viewer.preset.badge.blueprint": ["BLUEPRINT / REV 01", "蓝图 / 修订 01"],
  "viewer.preset.badge.editorial": [
    "EDITORIAL / FIELD NOTE",
    "编辑风格 / 现场笔记",
  ],
  "viewer.preset.badge.editorialPlate": [
    "ARCHIFY / PLATE 04",
    "ARCHIFY / 图版 04",
  ],
  "viewer.preset.current": [
    "Visual style: {style}. Choose visual style",
    "当前视觉风格：{style}。选择视觉风格",
  ],
  ...
  "viewer.motion.reduced": [
    "Motion paused by reduced-motion preference",
    "已根据减少动态效果偏好暂停动效",
  ],
  "viewer.motion.hidden": [
    "Motion paused while this page is hidden",
    "页面不可见时已暂停动效",
  ],
  "viewer.motion.yielding": [
    "Pause motion; currently yielding to {owner}",
    "暂停动效；当前让位于{owner}",
  ],
  "viewer.motion.yielding.title": [
    "Live preview enabled · yielding to {owner}",
    "动态预览已启用 · 正在让位于{owner}",
  ],
  ...
  "viewer.present.exit.title": [
    "Exit presentation stage (F or Escape)",
    "退出演示模式（F 或 Escape）",
  ],
  ...
  "viewer.export.unsupported": [
    "Not supported by this browser",
    "当前浏览器不支持",
  ],
  "viewer.export.clipboardUnsupported": [
    "Clipboard image write not supported by this browser",
    "当前浏览器不支持写入图片剪贴板",
  ],
  "viewer.export.clipboardUnsupported.period": [
    "Clipboard image write not supported by this browser.",
    "当前浏览器不支持写入图片剪贴板。",
  ],
  "viewer.export.clipboardUnsupported.short": [
    "Clipboard image write not supported in this browser.",
    "此浏览器不支持写入图片剪贴板。",
  ],
  "viewer.export.motionUnavailable": [
    "Motion capture unavailable in this browser",
    "当前浏览器无法录制动效",
  ],
  "viewer.export.webmUnavailable": [
    "WebM unavailable in this browser",
    "当前浏览器不支持 WebM",
  ],
  "viewer.export.failed": ["Export failed: {message}", "导出失败：{message}"],
  "viewer.export.unknownVariant": [
    "Unknown Share Card variant: {variant}",
    "未知的分享卡片类型：{variant}",
  ],
  "viewer.export.routeRequired": [
    "Trace a route before exporting a Route Share Card",
    "请先追踪路径，再导出路径分享卡片",
  ],
  "viewer.export.reachRequired": [
    "Trace authored reach before exporting a Reach Share Card",
    "请先追踪编写可达范围，再导出可达范围分享卡片",
  ],
  "viewer.export.unknown": ["unknown", "未知错误"],
  "viewer.export.routeFailed": [
    "Route Share Card export failed: {message}",
    "路径分享卡片导出失败：{message}",
  ],
  "viewer.export.reachFailed": [
    "Reach Share Card export failed: {message}",
    "可达范围分享卡片导出失败：{message}",
  ],
  "viewer.export.copyFailed": ["Copy failed: {message}", "复制失败：{message}"],
  "viewer.export.copiedPng": [
  ...
  "viewer.export.downloadedRoute": [
    "Downloaded Route Share Card",
    "已下载路径分享卡片",
  ],
  "viewer.export.downloadedReach": [
    "Downloaded Reach Share Card",
    "已下载可达范围分享卡片",
  ],
  "viewer.export.downloadedWebm": ["Downloaded WebM", "已下载 WebM"],
  "viewer.export.recording": [
    "Recording 6 seconds of motion…",
    "正在录制 6 秒动效…",
  ],
  "viewer.export.card.routeSummary.one": [
    "Route: {source} → {target} · {count} directed hop",
    "路径：{source} → {target} · {count} 个有向跳转",
  ],
  "viewer.export.card.routeSummary.other": [
    "Route: {source} → {target} · {count} directed hops",
    "路径：{source} → {target} · {count} 个有向跳转",
  ],
  "viewer.export.card.reachSummary": [
    "Authored {direction} from {origin} · {nodes} · {links} · max {hops}",
    "从{origin}开始的编写{direction} · {nodes} · {links} · 最深 {hops}",
  ],
  ...
  "viewer.export.card.routeBadge": [
    "ARCHIFY · ROUTE · {hops}",
    "ARCHIFY · 路径 · {hops}",
  ],
  "viewer.export.card.reachBadge": [
    "ARCHIFY · {direction} REACH",
    "ARCHIFY · {direction}可达范围",
  ],
  "viewer.export.card.defaultBadge": [
    "ARCHIFY · {preset} · {theme}",
    "ARCHIFY · {preset} · {theme}",
  ],
  "viewer.export.direction.upstream": ["Upstream", "上游"],
  "viewer.export.direction.downstream": ["Downstream", "下游"],
  "viewer.export.error.canvasUnavailable": [
    "Canvas unavailable for {label}",
    "无法为{label}使用画布",
  ],
  "viewer.export.error.contextUnavailable": [
    "2D canvas context unavailable for {label}",
    "无法为{label}创建二维画布上下文",
  ],
  "viewer.export.error.toBlobUnavailable": [
    "canvas.toBlob unavailable for {label}",
    "{label}无法使用 canvas.toBlob",
  ],
  "viewer.export.error.toBlobNull": [
    "canvas.toBlob returned no data for {label}",
    "{label}的 canvas.toBlob 未返回数据",
  ],
  "viewer.export.error.variantsCombined": [
    "Share Card variants cannot be combined",
    "无法同时组合多种分享卡片类型",
  ],
  "viewer.export.error.viewerState": [
    "Share Card export could not remove temporary viewer state",
    "分享卡片导出无法移除临时 Viewer 状态",
  ],
  "viewer.export.error.routeState": [
    "Route Card export could not preserve the resolved route safely",
    "路径卡片导出无法安全保留已解析路径",
  ],
  "viewer.export.error.reachState": [
    "Reach Card export could not preserve authored reach safely",
    "可达范围卡片导出无法安全保留编写的可达范围",
  ],
  "viewer.export.error.webmRequirements": [
    "WebM motion export requires a trace animation and browser MediaRecorder support",
    "WebM 动效导出需要追踪动画及浏览器 MediaRecorder 支持",
  ],
  "viewer.export.error.mediaRecorder": [
    "MediaRecorder failed",
    "MediaRecorder 录制失败",
  ],
  "viewer.export.error.emptyWebm": [
    "MediaRecorder produced an empty WebM",
    "MediaRecorder 生成了空的 WebM",
  ],
  "viewer.export.error.webmBackground": [
    "SVG background could not be loaded for WebM export",
    "无法为 WebM 导出加载 SVG 背景",
  ],

  "viewer.guided.region": ["Guided diagram views", "图表引导视图"],
  "viewer.guided.previous": ["Previous guided view", "上一个引导视图"],
  "viewer.guided.previous.title": [
  ...
  "viewer.guided.motionUnavailable": [
    "Story playback unavailable while motion is Still",
    "静态模式下无法播放故事",
  ],
  "viewer.guided.enableMotion": [
    "Switch motion to Live to play the guided story",
    "切换为动态模式以播放引导故事",
  ],
  "viewer.guided.selectBeatLink": [
  ...
  "viewer.guided.momentCopyFailed": [
    "Could not copy story moment link",
    "无法复制故事时刻链接",
  ],
  ...
  "viewer.guided.storyTrail": [
    "Story trail for {label}: {count} beats",
    "{label}的故事轨迹：{count} 个节点",
  ],
  "viewer.guided.chapter.open": [
    "Open chapter {index} of {total}: {label}, {count} stops",
    "打开第 {index}/{total} 章：{label}，{count} 个停靠点",
  ],
  "viewer.guided.chapter.current": [
    "Current chapter {index} of {total}: {label}, {count} stops",
    "当前第 {index}/{total} 章：{label}，{count} 个停靠点",
  ],
  "viewer.guided.chapter.selectedNodes": [
  ...
  "viewer.guided.chapter.current.title": [
    "{label} — current chapter, {count} stops",
    "{label} — 当前章节，{count} 个停靠点",
  ],
  "viewer.guided.chapter.delta.expanded": [
    "{stay} stay, {enter} enter, {leave} leave",
    "{stay} 个保留，{enter} 个进入，{leave} 个离开",
  ],
  "viewer.guided.chapter.delta.aria": [
    "Open chapter {index} of {total}: {label}. Chapter focus delta: {delta}",
    "打开第 {index}/{total} 章：{label}。章节聚焦差异：{delta}",
  ],
  "viewer.guided.chapter.delta.title": [
    "{label} — {delta} chapter focus",
    "{label} — 章节聚焦 {delta}",
  ],
  "viewer.guided.handoff": [
    "{from} → {to} · via {label}",
    "{from} → {to} · 经由{label}",
  ],
  "viewer.guided.share.chapter": [
    "Chapter {index} / {total}",
    "章节 {index} / {total}",
  ],
  ...
  "viewer.guided.share.step": [
    "Step {index} / {total} · {label}",
    "步骤 {index} / {total} · {label}",
  ],
  "viewer.guided.share.staticMoment": [
    "{step} · Static moment",
    "{step} · 静态时刻",
  ],
  "viewer.guided.share.complete": [
    "{count} steps complete · {note}",
    "{count} 个步骤已完成 · {note}",
  ],
  "viewer.guided.share.settled": [
    "Path settled for reading.",
    "路径已稳定，可供阅读。",
  ],
  "viewer.guided.share.staticPath": [
    "{count} steps · Static path",
    "{count} 个步骤 · 静态路径",
  ],
  "viewer.guided.share.ready": [
    "{count} steps · Ready",
    "{count} 个步骤 · 就绪",
  ],
  "viewer.guided.share.aria": [
    "{state} chapter {index} of {total}: {label}. {beat}. {route}",
    "{state}，第 {index}/{total} 章：{label}。{beat}。{route}",
  ],
  "viewer.guided.beat.start": [
    "Beat {index} / {total} · {label} · starting point",
    "节点 {index} / {total} · {label} · 起点",
  ],
  "viewer.guided.beat.forward": [
    "Beat {index} / {total} · {from} → {to}",
    "节点 {index} / {total} · {from} → {to}",
  ],
  "viewer.guided.beat.reverse": [
    "Beat {index} / {total} · {from} → {to} · reverse authored link",
    "节点 {index} / {total} · {from} → {to} · 反向编写连接",
  ],
  "viewer.guided.beat.multiple": [
    "Beat {index} / {total} · {from} ⇄ {to} · {count} authored links",
    "节点 {index} / {total} · {from} ⇄ {to} · {count} 条编写连接",
  ],
  "viewer.guided.beat.group": [
    "Beat {index} / {total} · {from} · {to} · grouped · no direct link",
    "节点 {index} / {total} · {from} · {to} · 分组 · 无直接连接",
  ],
  "viewer.guided.beat.aria.prefix": [
    "Story beat {index} of {total}: {label}. ",
    "故事节点 {index}/{total}：{label}。",
  ],
  "viewer.guided.beat.aria.start": ["Starting point.", "起点。"],
  "viewer.guided.beat.aria.forward": [
    "From {from} through one authored forward relationship.",
    "从{from}经一条正向编写关系到达。",
  ],
  "viewer.guided.beat.aria.reverse": [
    "From {from}; the authored relationship points from {to} to {from}.",
    "从{from}出发；编写关系实际由{to}指向{from}。",
  ],
  "viewer.guided.beat.aria.multiple": [
    "From {from} through {count} authored relationships; shown without arbitrary motion.",
    "从{from}经 {count} 条编写关系到达；不使用任意动效。",
  ],
  "viewer.guided.beat.aria.group": [
    "Grouped from {from} with no direct authored relationship.",
    "与{from}分组展示，没有直接编写关系。",
  ],
  "viewer.guided.caption.start": ["Starting point", "起点"],
  "viewer.guided.caption.grouped": [
    "Grouped transition · no direct authored link",
    "分组过渡 · 无直接编写连接",
  ],
  "viewer.guided.caption.more": [" +{count} more", " +另外 {count} 条"],
  "viewer.guided.caption.reverse": [
    "Reverse authored relationship",
    "反向编写关系",
  ],
  "viewer.guided.caption.relationships": [
    "{count} authored relationships",
    "{count} 条编写关系",
  ],
  "viewer.guided.caption.relationship": ["Authored relationship", "编写关系"],
  "viewer.guided.caption.direction": [
    "authored direction: {from} → {to}",
    "编写方向：{from} → {to}",
  ],
  "viewer.guided.caption.starting": ["Authored starting point", "编写起点"],
  "viewer.guided.beatLink": [
    "Copy link to current story moment: Beat {index} of {total}: {label}",
    "复制当前故事时刻链接：第 {index}/{total} 个节点：{label}",
  ],
  "viewer.guided.noStory": [
    "This diagram has no authored guided story.",
    "此图表没有编写引导故事。",
  ],

  "viewer.guide.eyebrow": ["Diagram guide", "图表指南"],
  "viewer.guide.close": ["Close diagram guide", "关闭图表指南"],
  "viewer.guide.inspecting": [
    "Inspecting compiled semantics",
    "正在检查已编译语义",
  ],
  "viewer.guide.actions": ["Diagram exploration actions", "图表探索操作"],
  "viewer.guide.find": ["Find any node", "查找任意节点"],
  "viewer.guide.find.hint": [
    "Search labels, responsibilities, kinds, and stable IDs.",
    "搜索标签、职责、类型和稳定 ID。",
  ],
  "viewer.guide.route": ["Trace a route", "追踪路径"],
  "viewer.guide.route.aria": ["Trace a directed route", "追踪有向路径"],
  "viewer.guide.route.hint": [
    "Ask how two semantic nodes connect in authored direction.",
    "查看两个语义节点如何按编写方向连接。",
  ],
  "viewer.guide.map": ["See the whole system", "查看完整系统"],
  "viewer.guide.map.hint": [
    "Open Semantic Radar with a live viewport and stable nodes.",
    "打开带实时视口和稳定节点的语义雷达。",
  ],
  "viewer.guide.lens": ["Compare semantic kinds", "比较语义类型"],
  "viewer.guide.lens.hint": [
    "Count roles, reveal their traffic, and compare direct authored links.",
    "统计角色、显示流量并比较直接编写的连接。",
  ],
  "viewer.guide.story": ["Play the guided story", "播放引导故事"],
  "viewer.guide.story.hint": [
  ...
  "viewer.guide.present.hint": [
    "Give the live diagram the viewport without changing export.",
    "让实时图表占满视口，同时不改变导出。",
  ],
  ...
  "viewer.guide.facts": [
    "{nodes} · {relationships} · {views}",
    "{nodes} · {relationships} · {views}",
  ],
  "viewer.guide.fact.node.one": ["{count} semantic node", "{count} 个语义节点"],
  "viewer.guide.fact.node.other": [
    "{count} semantic nodes",
    "{count} 个语义节点",
  ],
  "viewer.guide.fact.relationship.one": [
    "{count} relationship",
    "{count} 条关系",
  ],
  "viewer.guide.fact.relationship.other": [
    "{count} relationships",
    "{count} 条关系",
  ],
  "viewer.guide.fact.view.one": ["{count} guided view", "{count} 个引导视图"],
  "viewer.guide.fact.view.other": [
    "{count} guided views",
    "{count} 个引导视图",
  ],
  "viewer.guide.story.available.one": [
    "Walk {count} authored chapter and its real relationships.",
    "浏览 {count} 个已编写章节及其真实关系。",
  ],
  "viewer.guide.story.available.other": [
    "Walk {count} authored chapters and their real relationships.",
    "浏览 {count} 个已编写章节及其真实关系。",
  ],
  "viewer.guide.story.unavailable": [
    "No authored guided story in this diagram.",
    "此图表没有编写引导故事。",
  ],
  "viewer.guide.open": ["Open diagram guide", "打开图表指南"],
  "viewer.guide.noStory": [
    "This diagram has no authored guided story.",
    "此图表没有编写引导故事。",
  ],
  ...
  "viewer.finder.result.routeStart": [
    "Choose {label} as route start",
    "选择{label}作为路径起点",
  ],
  "viewer.finder.result.routeTarget": [
    "Choose {label} as route destination, {links}",
    "选择{label}作为路径终点，{links}",
  ],
  "viewer.finder.status.empty": ["No matching nodes", "没有匹配的节点"],
  "viewer.finder.status.count.one": [
    "{count} matching node",
    "{count} 个匹配节点",
  ],
  "viewer.finder.status.count.other": [
  ...
  "viewer.finder.result.focus.one": [
    "Focus {label}, {count} related connection",
    "聚焦{label}，{count} 条相关连接",
  ],
  "viewer.finder.result.focus.other": [
    "Focus {label}, {count} related connections",
    "聚焦{label}，{count} 条相关连接",
  ],
  "viewer.finder.status.filtered": [
    "{visible} of {available} {noun}",
    "{visible}/{available} {noun}",
  ],
  ...
  "viewer.passport.evidence": [
    "Verified source evidence",
    "已验证的源代码证据",
  ],
  "viewer.passport.verified": ["Verified source", "已验证来源"],
  "viewer.passport.verificationScope": [
    "Verified against local Git at the pinned revision. Remote access has not been checked.",
    "已按固定修订版本验证本地 Git 证据，未检查远程访问权限。",
  ],
  "viewer.passport.reach": ["Authored reach", "编写可达范围"],
  "viewer.passport.reach.trace": [
    "Trace authored reachability",
    "追踪编写的可达性",
  ],
  "viewer.passport.upstream": ["Upstream", "上游"],
  "viewer.passport.downstream": ["Downstream", "下游"],
  "viewer.passport.upstream.trace": [
    "Trace upstream authored reachability",
    "追踪上游编写可达性",
  ],
  "viewer.passport.downstream.trace": [
    "Trace downstream authored reachability",
    "追踪下游编写可达性",
  ],
  "viewer.passport.close": ["Close semantic passport", "关闭语义护照"],
  "viewer.passport.copy": ["Copy link", "复制链接"],
  "viewer.passport.copy.focus": [
    "Copy link to focused node",
    "复制聚焦节点的链接",
  ],
  ...
  "viewer.passport.copyPinned": [
    "Copy link to pinned relationship",
    "复制固定关系的链接",
  ],
  "viewer.passport.copySource": [
    "Copy link to source node",
    "复制来源节点的链接",
  ],
  "viewer.passport.copy.focused.success": [
    "Focused node link copied",
    "已复制聚焦节点链接",
  ],
  "viewer.passport.copy.pinned.success": [
    "Pinned relationship link copied",
    "已复制固定关系链接",
  ],
  "viewer.passport.copy.focused.failed": [
    "Could not copy focused node link",
    "无法复制聚焦节点链接",
  ],
  "viewer.passport.copy.pinned.failed": [
    "Could not copy pinned relationship link",
    "无法复制固定关系链接",
  ],
  "viewer.passport.relationship.none": [
    "No connected relationships",
    "没有关联关系",
  ],
  "viewer.passport.relationship.count.one": [
    "{count} relation",
    "{count} 条关系",
  ],
  "viewer.passport.relationship.count.other": [
    "{count} relations",
    "{count} 条关系",
  ],
  "viewer.passport.relationship.show.one": [
    "Show {count} connected relationship",
    "显示 {count} 条关联关系",
  ],
  "viewer.passport.relationship.show.other": [
    "Show {count} connected relationships",
    "显示 {count} 条关联关系",
  ],
  "viewer.passport.relationship.summary": [
    "{out} outgoing · {in} incoming{loops}",
    "{out} 条出向 · {in} 条入向{loops}",
  ],
  "viewer.passport.relationship.loops": [
    " · {count} loop",
    " · {count} 条自环",
  ],
  "viewer.passport.relationship.explorer": [
    "Direct relationship explorer",
    "直接关系浏览器",
  ],
  "viewer.passport.relationship.help": [
    "Use arrow keys to explore relationships. Press Enter or Space to pin details; Escape clears.",
    "使用方向键浏览关系。按 Enter 或空格键固定详情；按 Escape 清除。",
  ],
  ...
  "viewer.passport.relationship.pinned": [
    "Pinned relationship · {from} → {to} · {label}",
    "已固定关系 · {from} → {to} · {label}",
  ],
  "viewer.passport.relationship.inspect": [
    "Inspect relationship {index} of {total}: {from} to {to}, {label}. Press Enter for details.",
    "检查第 {index}/{total} 条关系：{from} 到 {to}，{label}。按 Enter 查看详情。",
  ],
  ...
  "viewer.passport.relationship.row": [
    "{group}: {relationship}, {neighbor}",
    "{group}：{relationship}，{neighbor}",
  ],
  ...
  "viewer.passport.sourceCount.one": [
    "{count} verified source reference",
    "{count} 个已验证来源引用",
  ],
  "viewer.passport.sourceCount.other": [
    "{count} verified source references",
    "{count} 个已验证来源引用",
  ],
  "viewer.passport.sourceMarker": ["SRC", "来源"],
  "viewer.passport.beacon.one": [
    "{count} verified source; focus this node to inspect",
    "{count} 个已验证来源；聚焦此节点以检查",
  ],
  "viewer.passport.beacon.other": [
    "{count} verified sources; focus this node to inspect",
    "{count} 个已验证来源；聚焦此节点以检查",
  ],
  "viewer.passport.repository.open": [
    "Open verified repository revision {revision}",
    "打开已验证的仓库修订版本 {revision}",
  ],
  "viewer.passport.source.open": [
    "Open verified source {path} at revision {revision}",
    "打开修订版本 {revision} 中已验证的来源 {path}",
  ],
  "viewer.passport.source.openLink": ["Open ↗", "打开 ↗"],
  "viewer.passport.reach.upstream.one": [
    "Trace {count} upstream authored node",
    "追踪 {count} 个上游编写节点",
  ],
  "viewer.passport.reach.upstream.other": [
    "Trace {count} upstream authored nodes",
    "追踪 {count} 个上游编写节点",
  ],
  "viewer.passport.reach.downstream.one": [
    "Trace {count} downstream authored node",
    "追踪 {count} 个下游编写节点",
  ],
  "viewer.passport.reach.downstream.other": [
    "Trace {count} downstream authored nodes",
    "追踪 {count} 个下游编写节点",
  ],
  "viewer.passport.reach.noUpstream": [
    "No upstream authored nodes",
    "没有上游编写节点",
  ],
  "viewer.passport.reach.noDownstream": [
    "No downstream authored nodes",
    "没有下游编写节点",
  ],
  "viewer.passport.reach.status": [
    "{direction} · {nodes} nodes · {links} links · max {hops} hops",
    "{direction} · {nodes} 个节点 · {links} 条连接 · 最深 {hops} 跳",
  ],
  ...
  "viewer.route.copy.aria": [
    "Copy link to traced route",
    "复制已追踪路径的链接",
  ],
  "viewer.route.clear": ["Clear", "清除"],
  "viewer.route.clear.aria": ["Clear route probe", "清除路径探测"],
  "viewer.route.traced": ["Traced route", "已追踪路径"],
  "viewer.route.pickTwo": [
    "Pick two semantic nodes on the diagram",
    "在图表中选择两个语义节点",
  ],
  "viewer.route.pickOne": [
    "Pick a semantic node on the diagram",
    "在图表中选择一个语义节点",
  ],
  ...
  "viewer.route.overview.aria": [
    "Show complete route overview",
    "显示完整路径总览",
  ],
  "viewer.route.instructions": [
    "Choose the source, then the destination. Direction matters.",
    "先选择来源，再选择目标；方向很重要。",
  ],
  "viewer.route.destination": [
    "Choose a destination from {label}",
    "选择从{label}出发的目标",
  ],
  "viewer.route.destination.find": ["Find target", "查找目标"],
  "viewer.route.destination.find.aria": [
    "Find a reachable route destination",
    "查找可达的路径目标",
  ],
  "viewer.route.differentDestination": [
    "Choose a different destination",
    "选择其他目标",
  ],
  "viewer.route.distinct": [
    "A route needs two distinct semantic nodes.",
    "一条路径需要两个不同的语义节点。",
  ],
  "viewer.route.unreachable": [
    "No directed route to {label}",
    "没有通往{label}的有向路径",
  ],
  "viewer.route.unreachable.detail": [
    "{target} is not reachable from {source}. Pick a highlighted destination.",
    "从{source}无法到达{target}。请选择高亮的目标。",
  ],
  "viewer.route.start.instructions": [
    "Select the source. The next step will reveal only directed destinations.",
    "选择来源。下一步只会显示有向可达的目标。",
  ],
  "viewer.route.copy.success": ["Traced route link copied", "已复制路径链接"],
  "viewer.route.copy.failed": [
    "Could not copy traced route link",
    "无法复制路径链接",
  ],
  "viewer.route.position": [
    "Route position {index} of {total}: {label}",
    "路径位置 {index}/{total}：{label}",
  ],
  "viewer.route.step": [
    "Step {index} of {total} · {phase} · {label}",
    "第 {index}/{total} 步 · {phase} · {label}",
  ],
  "viewer.route.motionRequired": [
    "Automatic journey requires Live motion",
    "自动旅程需要动态模式",
  ],
  "viewer.route.trigger.clear": ["Clear traced route", "清除已追踪路径"],
  "viewer.route.overview.status": [
    "{nodes} · {hops} · shortest authored route",
    "{nodes} · {hops} · 最短编写路径",
  ],
  "viewer.route.overview.node.one": ["{count} node", "{count} 个节点"],
  "viewer.route.overview.node.other": ["{count} nodes", "{count} 个节点"],
  "viewer.route.overview.hop.one": [
    "{count} directed hop",
    "{count} 个有向跳转",
  ],
  "viewer.route.overview.hop.other": [
    "{count} directed hops",
    "{count} 个有向跳转",
  ],
  ...
  "viewer.route.destination.count.one": [
    "{count} directed destination available. Pick a highlighted node.",
    "有 {count} 个有向目标可用。请选择高亮节点。",
  ],
  "viewer.route.destination.count.other": [
    "{count} directed destinations available. Pick a highlighted node.",
    "有 {count} 个有向目标可用。请选择高亮节点。",
  ],
  "viewer.route.noOutgoing": [
    "No outgoing route starts here. Clear and choose another source.",
    "此处没有可用的出向路径。请清除后选择其他来源。",
  ],
  "viewer.route.result.title": ["{source} to {target}", "{source} 到 {target}"],
  "viewer.route.finder.source.title": ["Choose route start", "选择路径起点"],
  "viewer.route.finder.source.placeholder": [
    "Search route sources",
    "搜索路径来源",
  ],
  "viewer.route.finder.source.empty": [
    "No matching route sources",
    "没有匹配的路径来源",
  ],
  "viewer.route.finder.source.results": [
    "Nodes that can start a route",
    "可作为路径起点的节点",
  ],
  "viewer.route.finder.source.noun": ["route sources", "个路径来源"],
  "viewer.route.finder.source.badge": ["start", "起点"],
  "viewer.route.finder.target.title": [
    "Destination from {label}",
    "从{label}出发的目标",
  ],
  "viewer.route.finder.target.placeholder": [
    "Search reachable destinations",
    "搜索可达目标",
  ],
  "viewer.route.finder.target.empty": [
    "No matching reachable destinations",
    "没有匹配的可达目标",
  ],
  "viewer.route.finder.target.results": [
    "Reachable route destinations",
    "可达路径目标",
  ],
  ...
  "viewer.lens.legend.inspect.one": [
    "Inspect {label}, {count} node",
    "检查{label}，{count} 个节点",
  ],
  "viewer.lens.legend.inspect.other": [
    "Inspect {label}, {count} nodes",
    "检查{label}，{count} 个节点",
  ],
  "viewer.lens.kind.count.one": [
    "{label}, {count} node",
    "{label}，{count} 个节点",
  ],
  "viewer.lens.kind.count.other": [
    "{label}, {count} nodes",
    "{label}，{count} 个节点",
  ],
  "viewer.lens.compare.one": [
    "{first} → {second}: {forward} · {second} → {first}: {reverse} · {count} direct relationship",
    "{first} → {second}：{forward} · {second} → {first}：{reverse} · 共 {count} 条直接关系",
  ],
  "viewer.lens.compare.other": [
    "{first} → {second}: {forward} · {second} → {first}: {reverse} · {count} direct relationships",
    "{first} → {second}：{forward} · {second} → {first}：{reverse} · 共 {count} 条直接关系",
  ],
  "viewer.lens.single": [
    "{nodes} · {relationships} · connected peers remain visible",
    "{nodes} · {relationships} · 已连接节点保持可见",
  ],
  "viewer.lens.node.one": ["{count} {label} node", "{count} 个{label}节点"],
  "viewer.lens.node.other": ["{count} {label} nodes", "{count} 个{label}节点"],
  "viewer.lens.relationship.one": [
    "{count} touching relationship",
    "{count} 条相连关系",
  ],
  "viewer.lens.relationship.other": [
    "{count} touching relationships",
    "{count} 条相连关系",
  ],
  ...
  "viewer.radar.surface": [
    "Diagram overview. Click a node to focus it, or use arrow keys to pan.",
    "图表总览。点击节点进行聚焦，或使用方向键平移。",
  ],
  ...
  "viewer.radar.focus": [
    "Focus {label} from Semantic Radar",
    "从语义雷达聚焦{label}",
  ],
  "viewer.radar.status": [
    "{count} nodes · {viewport}",
    "{count} 个节点 · {viewport}",
  ],
  "viewer.radar.fullMap": [
    "{count} nodes · full map",
    "{count} 个节点 · 完整地图",
  ],
  "viewer.radar.compacted": [
    "Radar compacted to avoid covering the Semantic Passport or MAP controls.",
    "已收紧雷达，避免遮挡语义护照或地图控件。",
  ],
  "viewer.radar.cancelWaiting": [
    "Cancel semantic radar waiting for more MAP space",
    "取消等待更多地图空间的语义雷达",
  ],
  "viewer.radar.needsSpace": [
    "Semantic radar needs more visible MAP space",
    "语义雷达需要更多可见地图空间",
  ],
  ...
  "viewer.nav.camera.title": [
    "{semantic}{hint} · reset view (0)",
    "{semantic}{hint} · 重置视图（0）",
  ],
  "viewer.nav.camera.semantic": [
    "Semantic camera active · ",
    "语义相机已启用 · ",
  ],
  ...
  "viewer.nav.detail.map": [
    "Zoom in to reveal relationship labels and node context",
    "放大以显示关系标签和节点上下文",
  ],
  "viewer.nav.detail.read": [
    "Zoom in again to reveal tags and annotations",
    "再次放大以显示标签和注释",
  ],
  "viewer.nav.detail.full": ["Full diagram detail", "完整图表详情"],

  "viewer.intent.summary": [
    "{label}. {out} outgoing, {in} incoming{loops}. {total} connections. Press Enter for details.",
    "{label}。{out} 条出向，{in} 条入向{loops}。共 {total} 条连接。按 Enter 查看详情。",
  ],
...
for (const [key, messages] of Object.entries(MESSAGE_PAIRS)) {
  if (
    messages.length !== SUPPORTED_LOCALES.length ||
...
const CATALOGS = Object.fromEntries(
  SUPPORTED_LOCALES.map((locale, index) => [
    locale,
    Object.fromEntries(
      Object.entries(MESSAGE_PAIRS).map(([key, pair]) => [key, pair[index]]),
    ),
  ]),
);
...
export function translateMessage(locale, key, values = {}) {
  ...
  if (!Object.hasOwn(CATALOGS[resolved], key)) {
    throw new Error(
      `Missing Archify i18n message ${JSON.stringify(key)} for ${resolved}`,
    );
  }
...
export function viewerCatalog(locale) {
  ...
  return Object.fromEntries(
    Object.entries(CATALOGS[resolved]).filter(([key]) =>
...
export function localizeTemplate(template, locale) {
  return template.replace(/\{\{i18n:([a-zA-Z0-9_.-]+)\}\}/g, (_match, key) =>
    escapeHtml(translateMessage(locale, key)),
  );
}
