...
const REQUIRED_MIRRORED_DOCS = [
  "docs/vendor/pi-coding-agent/README.md",
  "docs/vendor/pi-coding-agent/docs/extensions.md",
  "docs/vendor/pi-coding-agent/docs/skills.md",
  "docs/vendor/pi-coding-agent/docs/tui.md",
  "docs/vendor/pi-coding-agent/examples/extensions/README.md",
  "docs/vendor/pi-coding-agent/sync-metadata.json",
];
...
async function main(): Promise<void> {
  ...
  for (const requiredDoc of REQUIRED_MIRRORED_DOCS) {
    if (!fs.existsSync(path.join(cwd, requiredDoc))) {
      throw new Error(`Missing mirrored PI docs artifact: ${requiredDoc}. Run 'npm run docs:sync-pi' and commit the changes.`);
    }
  }
